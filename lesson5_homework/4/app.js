...
function showMoreText(card) {
    ...
    const textToShow = "fksd sdfkjkl sdnfsdmf sdlfkjklds sdflkk sdslkgksf sdlgkjskg fdslkjklslkf sldkfjsdkf sdldsfjkldf sldkjdsfk sdfljkd slfkjdk  sdlfkjkk sdflkjdslkj sdlfkjkj sdlkjflksdj";
    // 6.2 внутри .product есть .productName, после него вставляем div.desc и текстом из переменной из п. 6.1
    card.productName.insertAdjacentHTML('afterend', `<div class='desc'>${textToShow}</div>`);
